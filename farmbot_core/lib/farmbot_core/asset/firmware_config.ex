defmodule FarmbotCore.Asset.FirmwareConfig do
  ...
  view firmware_config do
    %{
      ...
      movement_calibration_deadzone_x: firmware_config.movement_calibration_deadzone_x,
      movement_calibration_deadzone_y: firmware_config.movement_calibration_deadzone_y,
      movement_calibration_deadzone_z: firmware_config.movement_calibration_deadzone_z,
      movement_calibration_retry_x: firmware_config.movement_calibration_retry_x,
      movement_calibration_retry_y: firmware_config.movement_calibration_retry_y,
      movement_calibration_retry_z: firmware_config.movement_calibration_retry_z,
