defmodule FarmbotCore.BotStateNG.McuParams do
  ...
  def view(mcu_params) do
    %{
        ...
        movement_calibration_deadzone_x: mcu_params.movement_calibration_deadzone_x,
        movement_calibration_deadzone_y: mcu_params.movement_calibration_deadzone_y,
        movement_calibration_deadzone_z: mcu_params.movement_calibration_deadzone_z,
