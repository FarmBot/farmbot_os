...
# 67eb7a8
# Wed Feb 15 13:25:33 2017 -0800
# fix-farmware-env-vars-saving
...
release-rpi: rpi
	scripts/build_release_images.sh rpi 3.0.5-staging
...
release-rpi3: rpi3
	scripts/build_release_images.sh rpi3 3.0.5-staging
...
release-rpi2: rpi2
	scripts/build_release_images.sh rpi2 3.0.5-staging
