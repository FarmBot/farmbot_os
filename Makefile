...
release-rpi: rpi
	scripts/build_release_images.sh rpi 3.0.6-staging
...
release-rpi3: rpi3
	scripts/build_release_images.sh rpi3 3.0.6-staging
...
release-rpi2: rpi2
	scripts/build_release_images.sh rpi2 3.0.6-staging
