...
# 9823e19
# Mon Jan 23 15:25:28 2017 -0800
# if-this-one-works-out-will-publish-real-relase
...
release-rpi: rpi
	scripts/build_release_images.sh rpi 3.0.2-staging.4
...
release-rpi3: rpi3
	scripts/build_release_images.sh rpi3 3.0.2-staging.4
...
release-rpi2: rpi2
	scripts/build_release_images.sh rpi2 3.0.2-staging.4
