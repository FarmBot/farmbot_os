defmodule FarmbotCore.Asset.FarmwareInstallation.Manifest do
  ...
  def view(manifest) do
    %{
      ...
      farmware_tools_version_requirement:
        manifest.farmware_tools_version_requirement,
  ...
  defp validate_farmbot_os_version_requirement(%{valid?: false} = change),
    do: change
  ...
  defp validate_farmware_tools_version_requirement(%{valid?: false} = change),
    do: change
